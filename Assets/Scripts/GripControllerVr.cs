...
public class GripController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            if (ConnectedObject.GetComponent<InteractableVr>().touchCount == 0)//if our object isn't touching anything
            {
            ...
            } else if (ConnectedObject.GetComponent<InteractableVr>().touchCount > 0)//if it is touching something 
            {
